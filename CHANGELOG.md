...
- Scope management: assign presets to Global and Project scopes
- Inherit mode: project scope can inherit from global — automatically cleans up project-level config
- Project-level config output: writes env vars and directories to `{workspace}/.claude/settings.json`
